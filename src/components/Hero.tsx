      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            ...
            <span className="block text-blue-600 text-3xl md:text-4xl mt-2">Quality Care. Real Results.</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            ...
            <a
              ...
              className="inline-flex items-center justify-center bg-white text-blue-600 border-2 border-blue-600 px-8 py-4 rounded-lg font-semibold hover:bg-blue-50 transition-colors text-lg"
            >
