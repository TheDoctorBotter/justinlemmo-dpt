      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            See how physical therapy has helped patients achieve their recovery goals.
          </p>
        </div>
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              <div className="flex items-center mb-4">
                <Quote className="h-8 w-8 text-[#BB0000] mr-3" />
                <div className="flex">
        ...
        <div className="text-center mt-12">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="inline-flex items-center bg-[#BB0000] text-white px-8 py-4 rounded-lg font-semibold hover:bg-[#990000] transition-colors"
            >
              Call (956) 476-5310
            </a>
            <a
              href="#contact"
              className="inline-flex items-center bg-gray-900 text-white px-8 py-4 rounded-lg font-semibold hover:bg-black transition-colors"
            >
              Contact Us
            </a>
          </div>
